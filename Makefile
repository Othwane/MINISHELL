...
#    Updated: 2023/08/23 06:59:18 by aasselma         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRC =	minishell.c parsing.c utils_minishell.c signals.c print_errors.c ft_itoa.c ./parsing/errors.c \
		...
		./execution/exec_redir.c ./execution/herdoc.c ./execution/helper_file.c  \
		./builtins/echo_b.c ./builtins/pwd_b.c ./builtins/builtins.c ./builtins/cd_b.c \
		./builtins/exit_b.c ./builtins/export_b.c ./builtins/unset_b.c ./builtins/env_b.c \
		./builtins/builtins_utils.c ./builtins/short_func.c 
